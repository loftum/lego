...
namespace Visualizer.Rendering.Car
{
    public class CarRenderer : MTKViewDelegate
    {
        ...
        private readonly Vector3 _cameraWorldPosition = new Vector3(0, 0, 5);
        ...
        public CarRenderer(MTKView view, IRotationProvider positionProvider)
        {
            ...
            //view.SampleCount = 4;
            view.DepthStencilPixelFormat = MTLPixelFormat.Depth32Float; // MTLPixelFormat.Depth32Float_Stencil8;
            ...
            _vertexDescriptor = CarRendererFactory.CreateVertexDescriptor();
            _renderPipeline = CarRendererFactory.CreateRenderPipeline(device, library, view, _vertexDescriptor);
            _samplerState = CarRendererFactory.CreateSamplerState(device);
            _depthStaencilState = CarRendererFactory.CreateDepthStencilState(device);

            _scene = CarRendererFactory.BuildScene(library, _vertexDescriptor);
        ...
        public override void Draw(MTKView view)
        {
            ...
            encoder.SetDepthStencilState(_depthStaencilState);
        ...
        private void DrawNodeRecursive(Node node, Matrix4 parentTransform, IMTLRenderCommandEncoder encoder)
        {
            ...
            if (mesh != null)
            {
                ...
                encoder.SetVertexBuffer(node.VertexUniformsBuffer, (nuint) (Marshal.SizeOf<VertexUniforms>() * _uniformsIndex), 1);
                ...
                encoder.SetFragmentBuffer(node.FragmentUniformsBuffer, (nuint)(Marshal.SizeOf<FragmentUniforms>() * _uniformsIndex), 0);
